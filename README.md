...
## Limitations
Note that a ship's painting file's dimensions affects its placement in game. If the dimensions of your image is not correct, the image will be slightly offset causing issues with paintingface alignment. Different AL descramblers have varying exported dimensions for their images and I'm not sure if there's any sure-fire way of having your image match the in-game's algorithm of recreating the image.
